...
__WEBPACK_IMPORTED_MODULE_2_moment___default.a.locale('ko');
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.moment = __WEBPACK_IMPORTED_MODULE_2_moment___default.a;

document.addEventListener("DOMContentLoaded", function (event) {
    var comments = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
        el: '#comments',
        components: {
            'comment': __webpack_require__(158)
        },
        data: {
            user: null,
            comments: null
        ...
        methods: {
            ...
            comment: function comment() {
                ...
                this.$http.post(url, { 'content': content }).then(function (response) {
    ...
    if (document.getElementById('delete')) {
        document.getElementById('delete').onclick = function (e) {
            ...
            if (confirm('작성하신 글을 삭제하시겠습니까?')) {
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete(this.getAttribute('href')).then(function (response) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(11), __webpack_require__(136).setImmediate))
...
/* scopeId */
var __vue_scopeId__ = "data-v-d48d2490"
...
var update = __webpack_require__(162)("1312bcf6", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d48d2490\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Comment.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d48d2490\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Comment.vue");
...
// module
exports.push([module.i, "\n.comment[data-v-d48d2490] {\n  padding: 0 0.5em 0.5em 0.5em;\n  margin-bottom: 0.5em;\n  border-bottom: 1px dashed #cccccc;\n}\n.comment .comment-title[data-v-d48d2490] {\n    margin-bottom: 0.5em;\n}\n.comment .comment-title small.text-muted[data-v-d48d2490] {\n      margin-left: 1em;\n}\nul.reply[data-v-d48d2490] {\n  list-style: none;\n  border-left: 3px solid #e0e0e0;\n  margin: 0.5em 0;\n  padding-left: 1em;\n}\nul.reply li[data-v-d48d2490] {\n    padding: 0.5em 0;\n    border-bottom: 1px dashed #cccccc;\n}\nul.reply li[data-v-d48d2490]:last-child {\n      border-bottom: none;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        dateAt: function dateAt(date) {
            var now = this.moment();
            var d = this.moment(date);
        ...
        update: function update() {
            var url = window.location.pathname + '/comments/' + this.comment.id;
        ...
        remove: function remove(id) {
            ...
            if (confirm('댓글을 삭제하시겠습니까?')) {
                var url = window.location.pathname + '/comments/' + id;
        ...
        reply: function reply() {
            ...
            var url = window.location.pathname + '/comments/' + this.comment.id + '/reply';
...
var render = function() {
  ...
  return _c("div", { staticClass: "comment" }, [
    _c("div", { staticClass: "comment-title" }, [
      ...
      _c(
        "small",
        { staticClass: "text-muted", attrs: { title: _vm.comment.created_at } },
        [_vm._v(_vm._s(_vm.dateAt(_vm.comment.created_at)))]
      )
    ]),
    _vm._v(" "),
    _vm.status != "edit"
    ...
    _c(
      ...
      { staticClass: "reply" },
      [
        _vm._l(_vm.comment.children, function(childen) {
          return _c("li", { key: childen.id }, [
            _c("div", { staticClass: "comment-title" }, [
              childen.user_id == _vm.user
                ? _c("div", { staticClass: "pull-right small" }, [
                    _c(
                      "a",
                      {
                        attrs: { href: "#" },
                ...
                : _vm._e(),
              _vm._v(" "),
              _c("strong", [_vm._v(_vm._s(childen.user.name))]),
              _vm._v(" "),
              _c(
                "small",
                {
                  staticClass: "text-muted",
                  attrs: { title: childen.created_at }
                },
                [_vm._v(_vm._s(_vm.dateAt(childen.created_at)))]
              )
            ]),
            _vm._v(" "),
            _c("div", { domProps: { innerHTML: _vm._s(childen.content) } })
          ])
        }),
        _vm._v(" "),
        _vm.status == "reply"
