      ...
      <div class="content-box">
        ...
        <div class="p-3">
          ...
          <div class="row">
            <div class="col-6">
              @if ($writable)
              <a class="btn btn-sm btn-primary" href="{{ route('notices.create') }}" role="button">
                <i class="fas fa-pencil-alt" aria-hidden="true"></i> 글쓰기
              </a>
              <a class="btn btn-sm btn-secondary" href="{{ route('notices.edit', ['id' => $article->id]) }}" role="button">
            ...
            <div class="col-6 text-right">
              <a class="btn btn-sm btn-primary" href="{{ route('notices.index') }}" role="button">
